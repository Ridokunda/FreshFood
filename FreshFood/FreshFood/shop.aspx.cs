...
namespace FreshFood
{
    public partial class shop : System.Web.UI.Page
    {
        ...
        protected void LoadItems(Item item)
        {
            ...
            display += "<ul><li><a href='shop-detail.aspx?ID=" + item.Item_ID + "' data-toggle='tooltip' data-placement='right' title='View'><i class='fas fa-eye'></i></a></li>";
            ...
            display += "<a class='cart' href='#' id='addtocart' runat='server' onclick='LinkClicked' >Add to cart</a>";
            display += "</div></div>";
        ...
        protected void LinkClicked(object sender, EventArgs e)
        {
            ...
            bool add = sc.addItemonCart(2, 2, 3);
            if(add == true)
            {
